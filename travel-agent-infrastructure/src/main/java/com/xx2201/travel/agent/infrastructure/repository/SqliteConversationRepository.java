...
public class SqliteConversationRepository implements ConversationRepository, LongTermMemoryRepository {
    ...
    public void saveMessage(ConversationMessage message) {
        jdbcClient.sql("""
                        INSERT INTO conversation_message (id, conversation_id, role, content, agent_type, created_at)
                        VALUES (:id, :conversationId, :role, :content, :agentType, :createdAt)
                        """)
                .param("id", message.id())
    ...
    public List<ConversationMessage> findMessages(String conversationId) {
        return jdbcClient.sql("""
                        SELECT id, conversation_id, role, content, agent_type, created_at
